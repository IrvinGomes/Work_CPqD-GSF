...
#define MAX_SCHEDULING_INFO_LIST 				11 /* RRC accepts only upto 11 */
#define MAX_SI_MSG_NUM 						31
...
#define MAX_INTER_FREQ_CELLS                    128
#define MAX_PLMN_LIST 						6
#define MAX_EAID						3
#define MAX_CID_BYTES 						16
#define MAX_NUM_UMTS_NCL					256
#define MAX_NO_DRX_PROFILE 					2  /* Assuming DRX for two profiles only - 1 for SPS and other for non-SPS services */
...
/* Changes done to resolve bitmask issue found during TI Local Event testing */
...
#define MAX_SON_MEAS_CONFIG_OBJECT  	12
